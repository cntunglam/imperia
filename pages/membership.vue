...
<template>
    <div class="_body space-y-8">
        ...
        >
            <a role="tab" class="tab tab-xl text-black">My Account</a>
            <a role="tab" class="tab tab-xl text-black underline">Orders</a>
            <a role="tab" class="tab tab-xl text-black">Profile </a>
        ...
        <div class="grid h-64">
            ...
            <button class="btn btn-primary w-full place-self-end">Shop New Arrivals</button>
        </div>
    </div>
