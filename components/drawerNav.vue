  ...
  <div class="navbar bg-base-100">
    ...
    <div class="navbar-end flex md:hidden">
      ...
      <div :class="[isHidden ? 'invisible' : 'visible', 'relative']">
        ...
        <input type="text" placeholder="WHAT ARE YOU LOOKING FOR ?" class="input input-bordered border-t-black border-b-black border-l-0 border-r-0 rounded-none uppercase min-h-14 w-full max-w-full px-12 md:px-16 text-lg md:text-[11px]" />
      </div>
  </header>
</template>
<style>
