<template>
    <div class="px-4 w-full max-w-5xl mx-auto">
        <div class="py-4">
            <h2 class="text-[22px] md:text-[36px] text-center uppercase py-4 md:px-5">sign up for exclusive access</h2>
        ...
        <div class="form-control py-4 w-full space-y-6">
            ...
            <div class="flex flex-col space-y-4 md:space-x-8 md:flex-row md:space-y-0">
                <input type="email" placeholder="Email Address" class="w-full input uppercase input-bordered rounded-none border-1 border-black focus:outline-none focus:border-black focus:ring-1 focus:ring-black " />
                <input type="tel" placeholder="Phone Number" class="w-full input uppercase input-bordered rounded-none border-1 border-black focus:outline-none focus:border-black focus:ring-1 focus:ring-black " />
            </div>
